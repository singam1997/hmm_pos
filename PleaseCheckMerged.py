...
Original file is located at
    https://colab.research.google.com/drive/1tHc_0kgQfGnHIdqZ5QJzoazDEOoipAGb

#TODO
1) Iterate over all the cross validation sets and compute the mean of scores

2) Comment the test thing and Add new logic to it
...
train_dataset = train_sentences[4]
test_dataset = test_sentences[4]
